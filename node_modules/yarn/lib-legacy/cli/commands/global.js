...
let _list = (() => {
  ...
  return function _list(_x6, _x7, _x8, _x9) {
...
var _buildSubCommands = (0, (_buildSubCommands2 || _load_buildSubCommands()).default)('global', {
  add: (() => {
    ...
    function add(_x10, _x11, _x12, _x13) {
  ...
  ls: (() => {
    var _ref7 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, reporter, flags, args) {
      ...
      yield _list(config, reporter, flags, args);
    });

    function ls(_x14, _x15, _x16, _x17) {
  ...
  remove: (() => {
    ...
    function remove(_x22, _x23, _x24, _x25) {
  ...
  upgrade: (() => {
    ...
    function upgrade(_x26, _x27, _x28, _x29) {
  ...
  upgradeInteractive: (() => {
    ...
    function upgradeInteractive(_x30, _x31, _x32, _x33) {
