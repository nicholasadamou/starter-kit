  ...
  */
  ...
  resolveWorkspaces(root, rootManifest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      const files = yield (_promise || _load_promise()).default.all(patterns.map(function (pattern) {
        return (_fs || _load_fs()).glob(pattern.replace(/\/?$/, trailingPattern), { cwd: root, ignore: _this8.registryFolders });
      }));

      for (const file of new (_set || _load_set()).default((_ref3 = []).concat.apply(_ref3, (0, (_toConsumableArray2 || _load_toConsumableArray()).default)(files)))) {
        var _ref3;
        ...
        workspaces[manifest.name] = { loc: loc, manifest: manifest };
      }
  ...
  static create() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      let opts = _arguments3.length > 0 && _arguments3[0] !== undefined ? _arguments3[0] : {};
      let reporter = _arguments3.length > 1 && _arguments3[1] !== undefined ? _arguments3[1] : new (_index3 || _load_index3()).NoopReporter();
