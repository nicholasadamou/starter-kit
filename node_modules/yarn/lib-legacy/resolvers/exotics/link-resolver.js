...
class LinkResolver extends (_exoticResolver || _load_exoticResolver()).default {
  constructor(request, fragment) {
    ...
    this.loc = (_misc || _load_misc()).removePrefix(fragment, 'link:');
  }
  ...
  resolve() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      const manifest = !(yield (_fs || _load_fs()).exists(loc)) ? { _uid: '', name: name, version: '0.0.0', _registry: registry } : yield _this.config.readManifest(loc, _this.registry);
