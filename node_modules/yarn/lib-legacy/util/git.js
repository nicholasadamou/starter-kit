...
const env = (0, (_extends2 || _load_extends()).default)({}, process.env, {
  GIT_ASKPASS: '',
...
class Git {
  ...
  static spawn(args) {
    ...
    return (_child || _load_child()).spawn('git', args, (0, (_extends2 || _load_extends()).default)({}, opts, { env: env }));
  }
  ...
  static hasArchiveCapability(ref) {
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      try {
        yield Git.spawn(['archive', `--remote=${ref.repository}`, 'HEAD', Date.now() + '']);
        throw new Error();
      } catch (err) {
  ...
  static repoExists(ref) {
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      try {
        yield Git.spawn(['ls-remote', '-t', ref.repository]);
        return true;
      } catch (err) {
        return false;
      }
  ...
  _archiveViaRemoteArchive(dest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      yield Git.spawn(['archive', `--remote=${_this.gitUrl.repository}`, _this.ref], {
  ...
  _archiveViaLocalFetched(dest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      const hashStream = new (_crypto || _load_crypto()).HashStream();
      yield Git.spawn(['archive', _this2.hash], {
        cwd: _this2.cwd,
        process: function process(proc, resolve, reject, done) {
          const writeStream = (0, (_fs2 || _load_fs2()).createWriteStream)(dest);
          proc.on('error', reject);
  ...
  _cloneViaRemoteArchive(dest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      yield Git.spawn(['archive', `--remote=${_this3.gitUrl.repository}`, _this3.ref], {
  ...
  _cloneViaLocalFetched(dest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      yield Git.spawn(['archive', _this4.hash], {
        cwd: _this4.cwd,
        process: function process(proc, resolve, reject, done) {
          const extractor = tarFs.extract(dest, {
            dmode: 0o555, // all dirs should be readable
  ...
  fetch() {
    ...
    return (_fs || _load_fs()).lockQueue.push(gitUrl.repository, (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      if (yield (_fs || _load_fs()).exists(cwd)) {
        yield Git.spawn(['pull'], { cwd: cwd });
      } else {
        yield Git.spawn(['clone', gitUrl.repository, cwd]);
      }
  ...
  _getFileFromArchive(filename) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      try {
        return yield Git.spawn(['archive', `--remote=${_this7.gitUrl.repository}`, _this7.ref, filename], {
          process: function process(proc, update, reject, done) {
  ...
  _getFileFromClone(filename) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      try {
        return yield Git.spawn(['show', `${_this8.hash}:${filename}`], {
          cwd: _this8.cwd
        });
      } catch (err) {
        // file doesn't exist
  ...
  setRefRemote() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      const stdout = yield Git.spawn(['ls-remote', '--tags', '--heads', _this10.gitUrl.repository]);
      const refs = Git.parseRefs(stdout);
      return _this10.setRef(refs);
    })();
  }
